...
const Home = () => {
  return (
    ...
    <div className='text-center z-10 px-4'> 
        ...
        Dedicated and highly motivated engineering graduate seeking an entry-level position as a Engineer to apply strong       
        technical skills and a good educational background to contribute to innovative engineering projects
        </p>
